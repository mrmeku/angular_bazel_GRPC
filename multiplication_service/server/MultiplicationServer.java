...
public class MultiplicationServer {
  ...
  private void start() throws IOException {
    ...
    Runtime.getRuntime().addShutdownHook(new Thread() {
      ...
      public void run() {
        ...
        MultiplicationServer.this.stop();
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    final MultiplicationServer server = new MultiplicationServer();
    server.start();
    server.blockUntilShutdown();
  }

  static class MultiplicationServiceImpl
    ...
    public void product(ProductRequest req, StreamObserver<ProductResponse> responseObserver) {
      ProductResponse response = ProductResponse.newBuilder().build();
